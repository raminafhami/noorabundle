...
export const CustomsPreview = ({ data }: { data: FormData }) => {
  // console.log(
  //   data?.ProductsData?.flatMap((i) => i?.PackingType?.flatMap((f) => f))
  // );
                ...
                <div>
                  <table className="w-full">
                    ...
                    <tr className="border-b border-black">
                      ...
                      <td
                        dir="rtl"
                        className="py-2 px-1 text-center text-xsm font-bold border border-black border-l-0">
                        {Array.from(
                          new Set(
                  ...
                  <table className="w-full">
                    <tr>
                      <td className="py-2 px-1 text-center text-xsm font-bold ">
                        امضا نماینده صاحب کالا <br />
                        {data?.ProductOwnerSignature &&
                        data?.ProductOwnerSignature !== "" &&
                        data?.ProductOwnerSignature !== undefined ? (
                          <Image
                            src={data?.ProductOwnerSignature}
                            alt=""
                            width={80}
                            height={80}
                            className="mx-auto"
                      ...
                      <td className="py-2 px-1 text-center text-xsm font-bold ">
                        ...
                        data?.SamplerSignature !== "" &&
                        data?.SamplerSignature !== undefined ? (
                          <Image
                      ...
                      <td className="text-py-2 px-1 text-center text-xsm font-bold xs">
                        امضا هماهنگ کننده و مهر شرکت بازرسی <br />
                        {data?.CoordinatorSignature &&
                        data?.CoordinatorSignature !== "" &&
                        data?.CoordinatorSignature !== undefined ? (
                          <Image
                            src={data?.CoordinatorSignature}
                            alt=""
                            width={80}
                            height={80}
                            className="mx-auto"
