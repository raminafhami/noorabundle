...
import { InspectionPic } from "@/inspection/flows/_module/inspection-pic/InspectionPic";
import { InspectionProcessPage } from "@/inspection/flows/_module/inspection-process/InspectionProcessPage";
import { PageSecretariat } from "@/inspection/flows/ic/pages/PageSecretariat/PageSecretariat";
...
const PageSection = memo(function PageSection({
	...
	switch (section) {
		...
		case "inspection-process":
			return <InspectionProcessPage inspectionType={InspectionType.Source} />;
		default:
			return <></>;
	}
});
