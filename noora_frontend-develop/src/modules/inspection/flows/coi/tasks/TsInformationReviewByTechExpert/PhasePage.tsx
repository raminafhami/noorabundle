...
export function PhasePage() {
	...
	const { [ids.tsInformationReviewByTechExpertStatus]: reviewStatus } = fields;
	...
	return (
		<>
			<div className="grid grid-cols-12 gap-x-4 gap-y-6 md:gap-x-10">
				{task.data[ids.tsInformationReviewByTechManagerStatus] ? (
					<Referrer
						assigneeKey={AssigneeType.TechnicalManager}
						noteId={ids.tsInformationReviewByTechManagerNote}
						noteType="danger"
					/>
				) : (
					<Referrer
				...
				<div className="col-span-full !col-start-1 space-y-2 xs:col-span-9 sm:col-span-7 md:col-span-5 xl:col-span-3">
					<label htmlFor={ids.tsInformationReviewByTechExpertStatus}>
						نتیجه:
					</label>
					<Controller
						control={control}
						name={ids.tsInformationReviewByTechExpertStatus}
						...
						rules={{
							deps: [ids.tsInformationReviewByTechExpertNote],
				...
				<div className="col-span-full space-y-2">
					<label htmlFor={ids.tsInformationReviewByTechExpertNote}>
						توضیحات:
					</label>
					<Controller
						control={control}
						name={ids.tsInformationReviewByTechExpertNote}
						render={({ field, fieldState }) => (
							<>
								<Textarea {...field} />
								<FieldError error={fieldState.error} />
