...
import PageCertificate from "./PageCertificate/CertificateWidget";
import PageCoverLetter from "./PageCoverLetter/PageCoverLetter";
import MdLetterWidget from "./PageMdLetter/MdLetterWidget";
...
const PageSection = memo(function PageSection({
	...
	switch (section) {
		...
		case "inspection-process":
			return <InspectionProcessPage inspectionType={InspectionType.COI} />;
		default:
			return <></>;
	}
});
