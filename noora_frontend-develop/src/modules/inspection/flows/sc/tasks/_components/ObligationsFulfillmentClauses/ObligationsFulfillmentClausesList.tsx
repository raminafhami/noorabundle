...
export const ObligationsFulfillmentClausesList = memo(
	function ObligationsFulfillmentClausesList(): JSX.Element {
		const {
			task: { data },
		} = useTaskContext();

		const clauses: string[] = data[ids.contractObligationsFulfillmentClauses];
