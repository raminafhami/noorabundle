...
import { InvoiceBuyerUpdate } from "./InvoiceBuyerUpdate";
		...
		try {
			...
			const content = await generateTemplate({
				...
				data: {
					...
					[ids.buyer]: instance.parameters[ids.buyer],
					...
					[ids.caseType]: instance.parameters[ids.caseType],
					[ids.inspectionFeeInRial]:
						instance.parameters[ids.inspectionFeeInRial],
					[ids.invoiceDescription]: instance.parameters[ids.invoiceDescription],
					[ids.invoiceTax]: instance.parameters[ids.invoiceTax],
					[ids.invoiceToll]: instance.parameters[ids.invoiceToll],
					[ids.invoiceTotal]: instance.parameters[ids.invoiceTotal],
					[ids.invoiceTotalInText]: instance.parameters[ids.invoiceTotalInText],
				},
				...
				<div className="space-y-6">
					...
					<div className="flex gap-x-3">
							...
							onClick={async () => {
								const blob = await generateTemplate({
									...
									data: {
										...
										[ids.inspectionFeeInRial]:
											instance.parameters[ids.inspectionFeeInRial],
										[ids.invoiceDescription]:
											instance.parameters[ids.invoiceDescription],
										[ids.invoiceTax]: instance.parameters[ids.invoiceTax],
										[ids.invoiceToll]: instance.parameters[ids.invoiceToll],
										[ids.invoiceTotal]: instance.parameters[ids.invoiceTotal],
										[ids.invoiceTotalInText]:
											instance.parameters[ids.invoiceTotalInText],
									},
									output: "file",
									download: true,
								});
						...
						<div className="flex max-w-60 select-none items-center rounded-2xl border">
							<Link
								href={`${routes.app}/paymentGateway/standard/${instance.id}:${
							...
							>{`${routes.app}/paymentGateway/standard/${instance.id}:${
								invoiceType === InvoiceType.Preinvoice
									? "Preinvoice"
									: "Invoice"
							}`}</Link>
