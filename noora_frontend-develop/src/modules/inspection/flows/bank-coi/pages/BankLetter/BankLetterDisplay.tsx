...
import { bankLetterKeys } from "./BankLetterPage";
	...
	function BankLetterDisplay(): JSX.Element {
		...
		const downloadWord = () => {
			const wordBankLetterData = {
				...
				registrationOrderNo: toFarsiNum(
					instance.parameters[ids.registrationOrderNo],
				),
				registrationOrderDate: toFarsiNum(
		...
		return (
			<>
				<div className="space-y-6">
					<Head.Root>
						<Head.Title text="پیش نمایش نامه" />
					</Head.Root>
