...
interface FindUserProps {
  ...
  setUser: (data: UserApi | undefined) => void;
  open: boolean;
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild disabled={disabled}>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="text-[.9rem] justify-between w-full my-2 pl-[2.8rem] pr-[.5rem] border-2 bg-white rounded-2xl group relative text-ellipsis focus:border-blue-500 placeholder-gray-400 focus:text-black py-2 px-2 focus:outline-0"
        >
