...
import { LetterDownloadButton } from "./LetterDownloadButton";
						...
						<div className="space-y-4">
							...
							<div className="grid grid-cols-12 gap-6">
								<div className="col-span-full space-y-2 xs:col-span-6">
									<div className="text-muted-foreground">شماره نامه</div>
									<div>{instance.caseNo}</div>
								</div>

								{/* <div className="col-span-full space-y-2 xs:col-span-6">
									<div className="text-muted-foreground">ارسال کننده</div>
									<div>
								...
								<div className="col-span-full space-y-2 xs:col-span-6">
									<div className="text-muted-foreground">تایید کننده</div>
									<div>
										{instance.parameters.Assignees.reviewer.name ?? "نامشخص"}
									</div>
								</div> */}

								<div className="col-span-full space-y-2 xs:col-span-6">
									<div className="text-muted-foreground">تاریخ نامه</div>
									<div>{instance.parameters["LetterDate"]}</div>
								</div>
							</div>
						</div>
