...
function IncomeCategoriesList() {
	...
	const handleUpsertDialogOpen = useCallback((payload?: FinancialCategory) => {
		setUpsertDialogPayload(payload ?? { type: FinancialCategoryType.Income });
		...
		<>
			<Card>
				<CardHeader orientation="horizontal">
					<CardTitle>عناوین درآمدی</CardTitle>
					<CardNav>
						<Button
							type="button"
							variant="primary"
						...
						>
							<FaPlus />
							<span>ایجاد عنوان درآمدی جدید</span>
						</Button>
					</CardNav>
				</CardHeader>
