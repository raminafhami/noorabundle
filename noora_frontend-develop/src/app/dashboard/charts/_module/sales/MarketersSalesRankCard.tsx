...
function MarketersSalesRankCard() {
	...
	return (
		<>
			<CardHeader orientation="horizontal">
				<CardTitle>رتبه بندی بازاریابان بر اساس میزان فروش</CardTitle>
				<CardNav>
				...
				>
					<TableHeader>
						<TableRow>
							...
							<TableHead className="w-64">میزان فروش (ریال)</TableHead>
						</TableRow>
					</TableHeader>
					<TableBody>
						{data?.map((item, index) => (
