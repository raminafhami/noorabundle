...
function BranchesDebtsRankCard() {
		...
		(async () => {
			try {
				...
				const filters: string[] = [
					...
					"parameters.branch::exists",
					"parameters.branch::notMatch::null",
				...
				const data = result.data
					...
					.slice(0, 10)
					.map((x) => ({
						branch: x.select.parameters.branch,
	...
	return (
		<>
			<CardHeader orientation="horizontal">
				<CardTitle>رتبه بندی شعب بر اساس میزان بدهی</CardTitle>
				<CardNav>
