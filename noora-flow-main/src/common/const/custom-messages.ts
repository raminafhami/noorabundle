export class CustomMessages {
  ...
  static WORKFLOW_CREATED_NEW_VERSION =
    'workflow for this key is already present, created with the new version';
  ...
  static CHILD_PROCESS_INSTANCE_NOT_COMPLETED =
    'Child process instance not completed';
  ...
  static VALUE_PREPARED = 'DATA ARE PREPARED';

  static GROUP_CREATED = 'group is created';

  static USER_CREATED = 'USER_CREATED';

  static LOGIN_SUCCESSFULLY = 'LOGIN_SUCCESSFULLY';
